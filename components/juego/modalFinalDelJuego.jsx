...
import { obtenerPuntosPorSala } from "@/services/peliculas/api";
                              ...
                              <h2>{contador}</h2>
                                <div className="flex flex-col items-center justify-center">
                                    ...
                                    <button
                                        ...
                                        className="bg-gray-900 text-white dark:bg-blue dark:text-black hover:bg-opacity-90 rounded-md px-5 py-2 transition"
                                    >
                                        Compartir
                                    </button>
                                </div>

...
import ComoJugar from "@/components/landing/comoJugar";
const PrimeraSeccion = () => {
    return (<>

        <div>
            <div className="min-h-[75vh]" style={{ backgroundColor: "#ad2472" }}>
                <section className={styles.section} style={{ backgroundColor: "#ad2472" }}>
                  <ComoJugar/>
                </section>
